...
public class CartServiceImpl implements CartService {
    ...
    public CartServiceImpl(CartRepository cartRepository, CartDetailRepository cartDetailRepository,
                           ProductRepository productRepository, UserServiceImpl userService) {
        this.cartRepository = cartRepository;
        this.cartDetailRepository = cartDetailRepository;
        this.productRepository = productRepository;
        this.userService = userService;
    }
    public void handleAddProductToCart(String email, Long productId, HttpSession session, Integer quantity) {
